...
Then in the Postman you have to put in the URL input (post) (localhost:3001/auth/login)

If there is no problem with that request, you can start using the API (localhost:3001/...)
